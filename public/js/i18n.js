...
const DICT = {
  zh: {
    ...
    'login.subtitle': '記錄每一筆家庭收支', 'login.username': '暱稱', 'login.password': '密碼',
    'login.submit': '登入', 'login.error': '暱稱或密碼錯誤',
    ...
    'set.users': '使用者', 'set.addUser': '新增使用者', 'set.editUser': '編輯使用者', 'set.role': '權限', 'set.displayName': '顯示名稱', 'set.nickname': '暱稱', 'set.nameRequired': '請輸入暱稱', 'set.pwdRequired': '請輸入密碼',
  ...
  en: {
    ...
    'login.subtitle': 'Track every family income & expense', 'login.username': 'Nickname', 'login.password': 'Password',
    'login.submit': 'Sign in', 'login.error': 'Wrong nickname or password',
    ...
    'set.users': 'Users', 'set.addUser': 'Add user', 'set.editUser': 'Edit user', 'set.role': 'Role', 'set.displayName': 'Display name', 'set.nickname': 'Nickname', 'set.nameRequired': 'Nickname required', 'set.pwdRequired': 'Password required',
  ...
  id: {
    ...
    'login.subtitle': 'Catat setiap pemasukan & pengeluaran keluarga', 'login.username': 'Nama panggilan', 'login.password': 'Kata sandi',
    'login.submit': 'Masuk', 'login.error': 'Nama panggilan atau kata sandi salah',
    ...
    'set.users': 'Pengguna', 'set.addUser': 'Tambah pengguna', 'set.editUser': 'Edit pengguna', 'set.role': 'Peran', 'set.displayName': 'Nama tampilan', 'set.nickname': 'Nama panggilan', 'set.nameRequired': 'Nama panggilan wajib diisi', 'set.pwdRequired': 'Kata sandi wajib diisi',
